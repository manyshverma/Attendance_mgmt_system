...
<div class="panel-body">
	...
	<a href="view_it.php" class="btn btn-primary">View</a>
	<a href="add_it.php" class="btn btn-primary pull-right">Add</a>	
		...
		$result=$link->query($query);$b=false;
			...
			if(!$b){
				foreach($att as $key=> $value){
					if($value=="Present"){
						$query="insert into it(value,emp_id,date) values('Present','$key','$date')";
						$insertResult=$link->query($query);
						
						
					}
					else{
						$query="insert into it(value,emp_id,date) values('Absent','$key','$date')";
						$insertResult=$link->query($query);
					}
				}
